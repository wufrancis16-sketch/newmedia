const REAL_DATA = {
  "xiaohongshu": {
    ...
    "platformName": "小红书",
    "updateTime": "2026-08-28T01:12:16.169Z",
    "source": "小红书搜索",
    "items": [
      {
        "rank": 1,
  ...
  "douyin": {
    "platform": "douyin",
    "platformName": "抖音",
    "updateTime": "2026-08-28T01:12:16.170Z",
    "source": "搜狗搜索",
    "items": [
      {
        "rank": 1,
...
const XHS_COMMENT_ANALYSIS = {
  "generated_at": "2026-08-28T09:13:14.849674",
  "keywords": [
    "进销存",
    "财务软件",
    "ERP",
  ...
  "posts": [
    ...
    },
    {
      ...
      "representative_comments": [
        "erp不只是电脑编程，更在业务上。我是做erp的，只懂点销售订单，像有些金税就不懂，更不要说别的大模块如财务，生产。",
        ...
        "熟悉业务流程和系统架构，的确不难，目前最成熟的SAP也是屎山代码一大堆，扒开看里面全是过时的架构臃肿的理不清的逻辑线团。 所以主要还是看怎么用ai理出来一个先进的架构拓扑结构。"
      ],
      "content_suggestions": [
        {
          "type": "行业针对性",
    ...
    },
    {
      ...
      "representative_comments": [
        ...
        "四川的话，有点体量的就食品旺店通，服装聚水潭。像其它的药品3c数码也选这两家批次效期管理之类做的比较好。其它的erp在这边的实施团队都比不上这两家。有需可以咨询我，无偿",
        "大家不要再私信我了，我实在没时间回，直接联系他们吧@广东金云信|金蝶官方服务号"
      ],
      "content_suggestions": [
        {
          "type": "行业针对性",
          "title": "服务/咨询、医药/健康行业的财务软件怎么选？",
          "reason": "评论区'服务/咨询/医药/健康'行业用户占比高，针对性内容需求明确"
        },
        {
          "type": "竞品对比",
      ...
      "content_suggestions": [
        {
          "type": "行业针对性",
          "title": "餐饮行业的财务软件怎么选？",
          "reason": "评论区'餐饮'行业用户占比高，针对性内容需求明确"
        },
        {
          "type": "痛点解答",
    ...
    {
      "note_id": "6a4e4fc1000000001503e4a1",
      "title": "8月再准备系统集成，我的建议是：(上班版)",
      "author": "蜡笔小心眼子",
      "keyword": "项目管理",
      "likes": 612,
      "collects": 714,
      ...
      "content_suggestions": [],
      "url": "https://www.xiaohongshu.com/explore/6a4e4fc1000000001503e4a1"
    }
  ],
  "historical": [
    {
  ...
  "generated_content": {
    "generated_at": "2026-08-28T09:13:15.069693",
    "total": 12,
    "posts": [
      {
        "keyword": "进销存",
