const REAL_DATA = {
  "xiaohongshu": {
    ...
    "platformName": "小红书",
    "updateTime": "2026-07-29T08:26:17.854Z",
    "source": "小红书搜索",
    "items": [
      {
        "rank": 1,
  ...
  "douyin": {
    "platform": "douyin",
    "platformName": "抖音",
    "updateTime": "2026-07-29T08:26:17.855Z",
    "source": "搜狗搜索",
    "items": [
      {
        "rank": 1,
...
const XHS_COMMENT_ANALYSIS = {
  "generated_at": "2026-07-29T16:29:22.123796",
  "keywords": [
    "进销存",
    "财务软件",
    "ERP",
  ...
  "posts": [
    {
      "note_id": "69f8aa2700000000360306d0",
      "title": "金蝶大神救我",
      "author": "小名礼物",
      "keyword": "进销存",
      "likes": 53,
      ...
      "representative_comments": [
        "金蝶云星空不是三五个会计能运行的[笑哭R]",
        "盘点吧，很重要，有辅助核算（5个条件），先看看主要品种，分类后再确定用哪种模式，单位一定要确定好，可以有多单位换算，你们有没有轻制造模块？如果有bom核算单位可以做主单位",
        "那你还没用金蝶云星空呢……我都死了好几个月了……"
      ],
      "content_suggestions": [
        {
          "type": "行业针对性",
      ...
      "url": "https://www.xiaohongshu.com/explore/69f8aa2700000000360306d0"
    },
    {
    ...
    {
      "note_id": "6a4479540000000006036461",
      "title": "",
      "author": "来了老弟",
      "keyword": "ERP",
      "likes": 393,
      ...
      "representative_comments": [
        "自研成本高，现在很多都直接买我用过比较好的就是旺店通的",
        "其实得看做什么行业的吧，不同行业就要选行业软件，通用型软件调式磨合周期比较长，后期会涉及到很多定制收费，行业软件就不一样了，产品成熟、上线快、行业特性解决方案都是现成的，也能少很多成本，直接拿过去就能用[偷笑R]",
        "大公司直接金蝶用友[笑哭R]"
      ],
      "content_suggestions": [
        {
      ...
      "url": "https://www.xiaohongshu.com/explore/6a4479540000000006036461"
    },
    {
      "note_id": "695ddc4d0000000022022a89",
      "title": "这恐怕是我见过最完美的出入库登记表！",
      "author": "爱吃小熊饼干",
      "keyword": "库存管理",
      "likes": 1084,
      "collects": 666,
      ...
      "content_suggestions": [],
      "url": "https://www.xiaohongshu.com/explore/695ddc4d0000000022022a89"
    },
    {
      "note_id": "6a3dcd27000000001101f0e0",
      ...
      "pain_points": {},
      "representative_comments": [
        "不客气，里边有做账、报税、开票、汇算清缴等，都能练习哦[飞吻R]",
        "收费吗？",
        "收费的哇"
      ],
      "content_suggestions": [],
      "url": "https://www.xiaohongshu.com/explore/6a3dcd27000000001101f0e0"
    },
    {
  ...
  "generated_content": {
    "generated_at": "2026-07-29T16:29:22.322793",
    "total": 12,
    "posts": [
      {
        "keyword": "进销存",
        "title": "做餐饮的，用它管库存也太省心了吧",
        "body": "仓库里几百个SKU，型号规格多得记不住。每次漏记少记几件，月底盘点数字就是不对。过期了都不知道，客户退货才发现。明明进货了，系统里就是找不到。\n\n后来发现了一款好用的库存混乱软件，这些问题全解决了！\n\n✅ 扫码出入库一秒钟搞定，库存实时更新再也不怕对不上\n✅ 保质期临期自动预警，先入先出智能推荐，减少过期损失\n✅ 缺货超储双向提醒，智能生成补货清单，库存周转率翻倍\n✅ 多仓库调拨一键完成，总仓分仓库存灵活调配，跨仓发货不纠结\n✅ 供应商管理+采购建议，系统根据销量自动算出该进什么货进多少\n\n做批发的朋友们，与其被库存对不上折磨，不如试试这个进销存，用了一段时间确实省心！",
        "tags": [
          "#库存管理",
          "#批发零售",
          "#手机开单",
      ...
      {
        "keyword": "进销存",
        "title": "不会用电脑也能管好库存，太友好了",
        "body": "年纪大了，对手机电脑不太灵光。之前的软件买了一直没用起来，功能太多太复杂。服务员也不会用，培训了一遍又忘了。想换个简单的，但又怕功能不够用。\n\n后来发现了一款好用的上手难软件，这些问题全解决了！\n\n✅ 3分钟开通即可使用，专属客服一对一指导，不会的随时问\n✅ 手机操作跟聊微信一样简单，服务员半天就能上手，不用反复培训\n✅ 7x12小时专属客服在线，不会操作随时问，有人教不抓瞎\n✅ 一键导入旧数据，Excel表格直接搬过来，换系统不折腾\n\n同行朋友们真的可以试试这个进销存软件，698元起，说不定也能帮到你们解决库存管理的烦恼～",
        "tags": [
          "#进销存",
          "#库存管理",
          "#批发零售",
