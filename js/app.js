const REAL_DATA = {
  "xiaohongshu": {
    ...
    "platformName": "小红书",
    "updateTime": "2026-09-18T09:07:37.158Z",
    "source": "小红书搜索",
    "items": [
      {
        "rank": 1,
  ...
  "douyin": {
    "platform": "douyin",
    "platformName": "抖音",
    "updateTime": "2026-09-18T09:07:37.159Z",
    "source": "搜狗搜索",
    "items": [
      {
        "rank": 1,
...
const XHS_COMMENT_ANALYSIS = {
  "generated_at": "2026-09-18T17:08:41.559506",
  "keywords": [
    "进销存",
    "财务软件",
    "ERP",
  ...
  "posts": [
    {
      ...
      "content_suggestions": [
        ...
        {
          "type": "痛点解答",
          "title": "关于「数据不准」的真相——资深用户的避坑指南",
          "reason": "评论区中'数据不准'是最突出的用户痛点，直接回应可建立信任"
        }
      ],
    ...
    },
    {
      ...
      "representative_comments": [
        ...
        "从erp到表格[笑哭R]，实际上就是没预算，更不懂什么是erp[笑哭R]"
      ],
      "content_suggestions": [
        {
          "type": "行业针对性",
  ...
  "generated_content": {
    "generated_at": "2026-09-18T17:08:42.123283",
    "total": 12,
    "posts": [
      {
        "keyword": "进销存",
