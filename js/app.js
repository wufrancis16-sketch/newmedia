const REAL_DATA = {
  "xiaohongshu": {
    ...
    "platformName": "小红书",
    "updateTime": "2026-06-26T08:27:45.463Z",
    "source": "小红书搜索",
    "items": [
      {
        "rank": 1,
  ...
  "douyin": {
    "platform": "douyin",
    "platformName": "抖音",
    "updateTime": "2026-06-26T08:27:45.464Z",
    "source": "搜狗搜索",
    "items": [
      {
        "rank": 1,
...
const FINANCE_KEYWORDS_FALLBACK = [
  { text: '财务软件', weight: 100 },
  { text: '做账', weight: 95 },
  { text: '进销存', weight: 92 },
  { text: 'ERP系统', weight: 90 },
  { text: '库存管理', weight: 88 },
  { text: '业财一体', weight: 85 },
  { text: '出纳', weight: 82 },
  { text: '项目管理', weight: 80 },
